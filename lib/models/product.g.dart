...
void _productSerialize(
  ...
  writer.writeDouble(offsets[0], object.defaultSalePrice);
...
Product _productDeserialize(
  ...
  object.defaultSalePrice = reader.readDoubleOrNull(offsets[0]);
  object.id = id;
...
extension ProductQueryFilter
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> defaultSalePriceEqualTo(
    double? value, {
  ...
  QueryBuilder<Product, Product, QAfterFilterCondition> defaultSalePriceBetween(
    double? lower,
    double? upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension ProductQuerySortBy on QueryBuilder<Product, Product, QSortBy> {
  QueryBuilder<Product, Product, QAfterSortBy> sortByDefaultSalePrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultSalePrice', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> sortByDefaultSalePriceDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQuerySortThenBy
  ...
  QueryBuilder<Product, Product, QAfterSortBy> thenByDefaultSalePrice() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultSalePrice', Sort.asc);
    });
  }

  QueryBuilder<Product, Product, QAfterSortBy> thenByDefaultSalePriceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'defaultSalePrice', Sort.desc);
    });
  }
...
extension ProductQueryWhereDistinct
  ...
  QueryBuilder<Product, Product, QDistinct> distinctByDefaultSalePrice() {
    return QueryBuilder.apply(this, (query) {
...
extension ProductQueryProperty
  ...
  QueryBuilder<Product, double?, QQueryOperations> defaultSalePriceProperty() {
    return QueryBuilder.apply(this, (query) {
