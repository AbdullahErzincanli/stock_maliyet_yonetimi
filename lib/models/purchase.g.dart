...
void _purchaseSerialize(
  ...
  writer.writeString(offsets[1], object.marketName);
  writer.writeString(offsets[2], object.receiptImagePath);
...
Purchase _purchaseDeserialize(
  ...
  object.id = id;
  object.marketName = reader.readStringOrNull(offsets[1]);
  object.receiptImagePath = reader.readStringOrNull(offsets[2]);
...
extension PurchaseQueryFilter
  ...
  QueryBuilder<Purchase, Purchase, QAfterFilterCondition> marketNameIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Purchase, Purchase, QAfterFilterCondition> marketNameEqualTo(
    String? value, {
  ...
  QueryBuilder<Purchase, Purchase, QAfterFilterCondition> marketNameGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Purchase, Purchase, QAfterFilterCondition> marketNameLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Purchase, Purchase, QAfterFilterCondition> marketNameBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Purchase, Purchase, QAfterFilterCondition> marketNameStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Purchase, Purchase, QAfterFilterCondition> marketNameEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Purchase, Purchase, QAfterFilterCondition> marketNameContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Purchase, Purchase, QAfterFilterCondition> marketNameMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Purchase, Purchase, QAfterFilterCondition> marketNameIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'marketName',
        value: '',
...
extension PurchaseQuerySortBy on QueryBuilder<Purchase, Purchase, QSortBy> {
  ...
  QueryBuilder<Purchase, Purchase, QAfterSortBy> sortByMarketName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'marketName', Sort.asc);
    });
  }

  QueryBuilder<Purchase, Purchase, QAfterSortBy> sortByMarketNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'marketName', Sort.desc);
    });
  }

  QueryBuilder<Purchase, Purchase, QAfterSortBy> sortByReceiptImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'receiptImagePath', Sort.asc);
    });
  }

  QueryBuilder<Purchase, Purchase, QAfterSortBy> sortByReceiptImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension PurchaseQuerySortThenBy
  ...
  QueryBuilder<Purchase, Purchase, QAfterSortBy> thenByMarketName() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'marketName', Sort.asc);
    });
  }

  QueryBuilder<Purchase, Purchase, QAfterSortBy> thenByMarketNameDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'marketName', Sort.desc);
    });
  }

  QueryBuilder<Purchase, Purchase, QAfterSortBy> thenByReceiptImagePath() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'receiptImagePath', Sort.asc);
    });
  }

  QueryBuilder<Purchase, Purchase, QAfterSortBy> thenByReceiptImagePathDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'receiptImagePath', Sort.desc);
    });
  }
...
extension PurchaseQueryWhereDistinct
  ...
  QueryBuilder<Purchase, Purchase, QDistinct> distinctByMarketName(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Purchase, Purchase, QDistinct> distinctByReceiptImagePath(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension PurchaseQueryProperty
  ...
  QueryBuilder<Purchase, String?, QQueryOperations> marketNameProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'marketName');
    });
  }

  QueryBuilder<Purchase, String?, QQueryOperations> receiptImagePathProperty() {
    return QueryBuilder.apply(this, (query) {
